import { handleGetTransactionAdmin, handleGetTransactionByDate, handleGetTransactionByDateById, handleGetTransactionByProductByDate, handleGetTransactionDetails, handleSubTotalTransaction } from '@/controllers/transaction.controller';
...
transactionRouter.get('/get-by-date-by-id', handleGetTransactionByDateById);
