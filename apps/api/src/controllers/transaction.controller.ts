...
import { serviceGetTransactionAdmin, serviceGetTransactionByDate, serviceGetTransactionByDateById, serviceGetTransactionByProductByDate, serviceGetTransactionDetails, serviceSubTotal } from "@/services/transaction.service";
...
export const handleGetTransactionByDate = async (req: Request, res: Response) => {
  ...
  export const handleGetTransactionByDateById = async (req: Request, res: Response) => {
    try {
      const { date } = req.query;
      ...
      const result = await serviceGetTransactionByDateById(parsedDate, token);
  ...
  export const handleGetTransactionByProductByDate = async (req: Request, res: Response) => {
    try {
      const { date } = req.query;
      ...
      const result = await serviceGetTransactionByProductByDate(parsedDate);
